...
/**
* soap_server_backup/IControllerCopySecurityPackage/streamBytesHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from IServerBackup.idl
* Monday, August 8, 2022 10:20:54 AM COT
*/

abstract public class streamBytesHelper
{
  private static String  _id = "IDL:soap_server_backup/IControllerCopySecurity/streamBytes:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (soap_server_backup.IControllerCopySecurityPackage.streamBytesHelper.id (), "streamBytes", __typeCode);
    }
    return __typeCode;
  }
